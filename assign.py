...
st.title("Machinelearning Prediction Model")
with st.sidebar:
...
# Predict page
if choice == "Predict":
    loaded_model = pickle.load(open('C:\streamlit\trained_model.sav', 'rb'))
    ...
    def main():
        ...
        if st.button('Test Result'):
            Heartdisease = Heartdisease_prediction([anaemia, creatinine_phosphokinase, high_blood_pressure, DEATH_EVENT, smoking, sex, diabetes, age])
